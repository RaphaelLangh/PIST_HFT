...
public class Indicateur extends Observable {
	...
	private Acteurmodif createur;      // acteur a l'origine de la creation de l'indicateur
	 ...
	 */
	public Indicateur(String nom, Acteurmodif createur,  double valInit) {
		this.nom = nom;
	 ...
	 */
	public Indicateur(String nom, Acteurmodif createur) {
	 ...
	 */
	public Acteurmodif getCreateur() {
	 ...
	 */
	public void setValeur(Acteurmodif auteur, double valeur) {
